    ...
    <div>
        <div class="isolate bg-white">
            ...
            <div class="px-6 pt-6 lg:px-8">
                <div>
                    ...
                    >
                        <div
                            class="flex lg:min-w-0 lg:flex-1"
                            aria-label="Global"
                        >
                        ...
                        <div
                            class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end"
                        >
                            <NuxtLink
                                to="/login"
                    ...
                    <TransitionRoot as="template" :show="mobileMenuOpen">
                        <Dialog as="div" @close="mobileMenuOpen = false">
                            <DialogPanel
                                focus="true"
            ...
            <main>
                <div class="relative px-6 lg:px-8">
                    <div
                        class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40"
                    >
                        <div>
                            <div
        ...
        <div class="bg-white">
            <div class="mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8 lg:py-40">
                ...
                <dl
                    class="mt-20 grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8"
                >
                    <div
                    ...
                    >
                        <dt>
                            <CheckIcon
                                class="absolute mt-1 h-6 w-6 text-indigo-600"
                                aria-hidden="true"
                            />
                            <p
                                class="ml-10 text-lg font-semibold leading-8 text-gray-900"
                            >
                                {{ feature.name }}
                            </p>
                        </dt>
                        <dd
                            class="mt-2 ml-10 text-base leading-7 text-gray-600"
                        >
                            {{ feature.description }}
                        </dd>
                    </div>
