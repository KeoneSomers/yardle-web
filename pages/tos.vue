...
<template>
  <div class="prose-sm mx-auto my-20 max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Yardle.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Yardle, accessible from
          <a
            href="https://www.yardle.app"
            rel="external nofollow noopener"
            target="_blank"
            >https://www.yardle.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: info@yardle.app</li>
    </ul>
  </div>
</template>
