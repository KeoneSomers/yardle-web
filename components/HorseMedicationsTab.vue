    ...
    const people = [
        {
            ...
            email: "lindsay.walton@example.comlindsay.walton@example.comlindsay.walton@example.comlindsay.walton@example.comlindsay.walton@example.comlindsay.walton@example.com",
            role: "Member",
        },
    ];
</script>
