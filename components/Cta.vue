    ...
    <div class="relative mx-auto max-w-7xl py-24 sm:py-32 lg:py-40 lg:px-8">
      ...
      >
        ...
        <p class="mt-6 text-base leading-7 text-gray-300">
          Yardle is a comprehensive yard management platform for horse owners
          and equestrian enthusiasts to simplify and streamline horse
          management. It provides tools for adding and collaborating on horse
          information, intuitive drag and drop interface for field management,
          and a calendar for keeping track of horse events such as farrier
          visits and worming appointments. Yardle's powerful features and
          intuitive design aim to revolutionize equestrian yard management,
